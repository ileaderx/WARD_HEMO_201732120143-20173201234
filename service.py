...
class ArticleService:
    ...
    def find_all_article(self,Article):
        articles = Article.query.all()
        return articles

    def find_by_title(self,title, Article):
    ...
    # 考虑名称是否有用错
    def find_by_user(self,user_id, Article):
...
class IPService:
    ...
    def find_aip_by_ipid(self,ip_id, ArticleIp):
        aip = ArticleIp.query.filter_by(ip_id=ip_id).first()
        return aip

    def find_aip_both(self,article_id, ArticleIp):
        aip = ArticleIp.query.filter_by(article_id=article_id).first()
        return aip

    def find_cip_by_ipid(self,ip_id, CommentIp):
        cip = CommentIp.query.filter_by(ip_id=ip_id).first()
        return cip

    def find_cip_by_both(self,comment_id,ip_id, CommentIp,id):
        return CommentIp.query.filter_by(comment_id=comment_id,ip_id=ip_id,).first(),id
...
class CommentService:
    ...
    def find_by_userid(self,user_id, Comment):
